...
class PapaPuzzleScene:
    def __init__(self, screen):
        ...
        if os.path.exists(fanfare_path):
            try:
                ...
                self.fanfare_duration = 3000  # asumimos ~3 segundos; ajusta si sabes la duración real
    ...
    def check_answer(self, choice):
        if choice == self.correct:
            ...
            if self.use_fanfare:
                ...
                # Sin fanfarria: salir en 2 segundos
    ...
    def draw(self):
        ...
        hint = pygame.font.SysFont(None, 28).render("Presiona A, B o C para responder", True, LIGHT_YELLOW)
